...
I mean to make this run on a few strategically placed locations around the globe to keep track of performance sites that I find interesting. Don't take this project too seriously, I'm using it mainly to get some practice with typescript/deno and running globally distributed jobs. Feel free to use it for any purpose.
